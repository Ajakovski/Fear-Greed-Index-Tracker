...
<img src="Pictures/Gadget.png" width="45%" height="500" alt="">
<img src="Pictures/Transparent_gadget.png" width="45%" height="500" alt="">
</p>
...
Have you ever felt overwhelmed by the sheer amount of work that you have limiting your counciousness that you **HAVE** to check the US stock market because your whole childhood lifesavings could be **GONE** thanks to **YOUR** irresponsible trading???
...
A portable working-desk gadget to remind you of the madness happening in the US market world. Thanks to the ESP32 WiFi integrations we can fetch data from the internet and make this cool project alive on your desk.
...
```
*If multiple versions are available i recommend sticking to the newest one because i dont commit until its fully tested*
...
Prefer using wires without pins and soldering  on top of the ESP Devkit unless you have an extension that could be mounted onto the male pins of the ESP32.
...
- 4x M3 screw
- Notice: if you dont get screws with the TFT lcd screen you will have to acquire them personally

***Steps for assembling***

The main and only part of assembling the casing is mounting the hat.
There are three steps for this:
- Align the hat on top of the casing and in the desired screw holes you have mark them in any possible way either pen, pencil or etc.
- Get the M3 brass hot melt insert nuts and with a soldering iron melt them into the casing.
...
Thanks to the newest tariffs by our president (20% tax import on international goods) ***EVERYTHING IS COOKED WITH PRICES***

*Notice: These shipping costs are for the Balkans so if you are from the EU or USA there are high chances of having lower shipping costs*

*Notice: These are just recommendations that i have found to be secure and hopefully the cheapest option. Do your own research if you think that better deals exist on the current market depending on when you are buying them.*

---

## Features

- **Live Market Data** - Real market data for monitoring the US market
...
- **Deep Sleep** - power saving mode and market data retained in RTC memory across sleep cycles
- **Fuel Gauge** - Battery monitoring and safety guardrails
- **Longevity** - Battery lasts up to 30 working hours
...
|---|---|---|
| MCU | ESP32-WROOM-32 | 8MB Flash, None PSRAM, Xtensa LX6 dual-core |
| LED Strip| WS2812S Strip | Addressable LED strip |
| Display | 128x160 TFT 1.8' | SPI Interface |
| Battery | Li-Ion 18650 3600mAh battery | |
| Charger | TP4056 w. DWA01A+FS8205A | Single-cell Li-ion, USB-C input, battery protection |
| 3.3V Rail | TPS63020 | Buck-Boost converter |
| Fuel Gauge | MAX17048 | Battery measure, sate of charge estimation |
...
| Signal | ESP32-WROOM-32 GPIO | Goes to |
|---|---|---|
| PIN_TFT_SCLK | 18 | TFT SCL |
| PIN_TFT_MOSI | 23 | TFT MOSI |
| PIN_TFT_CS | 27 | TFT CS |
| PIN_TFT_DC | 26 | TFT DC |
| PIN_TFT_RST | 25 | TFT RST |
| PIN_TFT_BL | 33 | TFT BL |
| PIN_BTN_POWER | 4 | Power Button |
| PIN_BTN_NAV1 | 19 | Nav1 Button |
| PIN_BTN_NAV2 | 21 | Nav2 Button |
| PIN_FG_SDA | 16 | Fuel gauge SDA |
| PIN_FG_SCL | 17 | Fuel gauge SCL |
| PIN_FG_ALRT | 35 | Fuel gauge alert |
| PIN_RGB_LED_DIN | 14 | RGB LED Strip |
...
- 10% infill on the whole 3D model
...
For significant hardware changes, open an issue first to discuss before investing time in schematic work. Any new implementation must be self-contained in its own `.c`/`.h` pair.
...
## Disclaimer
_This Device displays market sentiment data for informational purposses. It is not financial advice whatsoever._
